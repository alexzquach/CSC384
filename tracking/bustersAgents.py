...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        [most_likely_position.append(max(distance, key=distance.get)) for distance in livingGhostPositionDistributions]

        # Get our minimum distance / position
        our_distances = util.Counter()
        for position in most_likely_position:
            our_distances[position] = self.distancer.getDistance(pacmanPosition, position)
        ...
        for legal_action in legal:
            ...
            our_actions[legal_action] = self.distancer.getDistance(successor_position, shortest_position)
